    ...
    <footer className="position-fixed bottom-0 w-100 bg- text-white py-3 px-6 flex items-center justify-between">
      <div className="flex items-center space-x-4">
        ...
        <div className="social-icons flex items-center space-x-3">
          <a href="https://www.instagram.com/onmi.es" className="opacity-75 hover:opacity-100">
      ...
      <nav className="flex space-x-4">
        <Link to="/" className="text-white text-sm opacity-75 hover:opacity-100">Navigate</Link>
        <Link to="/contactus" className="text-white text-sm opacity-75 hover:opacity-100">Contact us</Link>
        <Link to="/login" className="text-white text-sm opacity-75 hover:opacity-100">Log in</Link>
      </nav>
